...
public class ImageActivity extends Activity {
    ...
    private void requestPermissionsDownloadHandler(){
        System.out.println("Downloading image...");
        System.out.println("Requesting permissions for file access");
        if(Build.VERSION.SDK_INT >= 23){
            ...
            if(check_permission){
                Log.e("value", "Permission already Granted, Now you can save an image");
            } else {
                if(ActivityCompat.shouldShowRequestPermissionRationale(ImageActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    Toast.makeText(ImageActivity.this, "Write External Storage permission allows us to store images.  Allow permissions in App settings.", Toast.LENGTH_LONG).show();
    ...
    private void initView() {
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    //Alter permissions request location.  This causes the app to crash on the first run-through.
                requestPermissionsDownloadHandler();
                ...
                if (!isDownloading) {
                    ...
                    DownloadManager.Request request = new DownloadManager.Request(Uri.parse(imageData.file_url));
                        //This line is giving us problems.  What's the problem?
